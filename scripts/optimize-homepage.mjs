...
const splineStageMarkup =
  '<div class="v3-hero-spline-stage" data-spline-stage data-spline-stage-state="idle"><div class="v3-hero-spline" data-spline-scene data-spline-state="idle" data-spline-delay="0" data-spline-reveal-delay="1200" data-spline-src="/home-v2/spline-scenes/game-transparent.js?v=2"></div></div>';
...
if (!html.includes("/_astro/hero-spline.css")) {
  html = replaceOnce(
    ...
    '<link rel="stylesheet" href="/_astro/staged-media.css"><link rel="stylesheet" href="/_astro/hero-spline.css?v=6">',
...
if (!html.includes("/_astro/hero-spline-loader.js")) {
  html = replaceOnce(
    ...
    '<script type="module" src="/_astro/hero-native.js"></script><script type="module" src="/_astro/hero-spline-loader.js?v=5"></script>',
    "hero Spline loader",
  );
}
